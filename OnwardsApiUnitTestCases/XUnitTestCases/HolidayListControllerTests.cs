...
namespace OnwardsApiUnitTestCases.XUnitTestCases
{
    public class HolidayListControllerTests
    {
        ...
        //{
        //    var expected = new List<HolidayListDto> { new HolidayListDto { Id = 1 } };
        ...
        //{
        //    var dto = new HolidayListDto { Id = 1 };
        ...
        //{
        //    var dto = new OnwardsModel.Model.HolidayListModel { Id = 1 };
        //    _mockService.Setup(s => s.InsertOrUpdateHoliday(dto)).Throws(CreateSqlException());

        //    var result = _controller.InsertOrUpdateHoliday(dto) as ObjectResult;
        ...
        //{
        //    var dto = new HolidayListDto { Id = 1 };
        //    _mockService.Setup(s => s.InsertOrUpdateHoliday(dto)).Throws(new Exception("Error"));

        //    var result = _controller.AInsertOrUpdateHolidaydd(dto) as ObjectResult;
        ...
        //{
        //    var dto = new HolidayListDto { Id = 2 };
        ...
        //    var result = _controller.InsertOrUpdateHoliday(1, dto) as ObjectResult;
        ...
        //{
        //    var dto = new HolidayListDto { Id = 1 };
        //    _mockService.Setup(s => s.InsertOrUpdateHoliday(dto)).Throws(new Exception("Unexpected"));
